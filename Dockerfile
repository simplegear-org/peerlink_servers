...
COPY relay.js relay-storage.js relay-validation.js relay-lifecycle.js relay-meta-routes.js relay-request-validation.js relay-data-routes.js signal.js push.js server-checker.js observability.js source-info.js invite.js ./
...
FROM base AS relay
ARG PEERLINK_SERVERS_VERSION=1.7.5+2026091702
ARG PEERLINK_SOURCE_REF=source-v1.7.5+2026091702
