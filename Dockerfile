...
COPY relay.js relay-storage.js signal.js push.js server-checker.js observability.js source-info.js invite.js ./
...
FROM base AS relay
ARG PEERLINK_SERVERS_VERSION=1.7.3+2026091602
ARG PEERLINK_SOURCE_REF=source-v1.7.3+2026091602
